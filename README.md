...
I am a highly motivated and passionate Full-stack Software Engineer with a background in People Operations. I am committed to building strong relationships through collaboration, communication and respect. My career goals are making significant contributions to the organisation I work for, continuously learning to support my professional growth, and being able to help people from underrepresented groups start their tech journey. I am a Makers Alumni and proud Co-Founder of [Pensano Developers](https://pensano.dev/), a platform that empowers graduates to develop their skills by working collaboratively. </br>

I am passionate about building strong relationships and believe that collaboration, communication, and respect are essential for any successful project. For highlights of my professional skills from peers and managers, please have a look at my [LinkedIn Recommendations](https://www.linkedin.com/in/juliana-nocchi-b4a882222/details/recommendations/?detailScreenTabIndex=0).
...
| [**Pensano Showcase Website**](https://pensano.dev/)| This website was designed to showcase my peer group work both collectively, as Pensano Devs, and our individual projects. I was involved in the ideation, UI, prototyping, creating components, implementing functionalities, home page responsiveness and styling. [GitHub link](https://github.com/Pensano-dev/website)| React, CSS, HTML|
...
- Selected among 500 candidates to join a group of 20 women in this program which aims to increase the representation of women in tech 
- 12-week instructor-led training course using Ajax, CSS3, HTML5, Java, Javascript, JSON, jQuery, JUnit, MySQL, RESTful APIs, Spring Boot, and VCS(Git and GitHub)

#### EMEA Chief of Staff & Office Manager
...
## 🧸 Soft Skills
### **Problem Solving**
As someone who enjoys taking on new challenges and being part of new initiatives, I have spent years studying immigration law, brainstorming potential solutions, and collaborating with colleagues to achieve a 100% visa approval rate. As a developer, I break complex problems down into manageable parts using TDD and using analogies to make abstract concepts more accessible. I also enjoy pairing with colleagues to solve codewars, and learn new techniques and methodologies. For example, when we realized our website's home page needed a 'Mobile first' approach, I paired with a colleague to create a plan and break down the tasks into smaller pieces. After implementing the changes, we explained the concept to the team and followed this product design principle when starting a new page, resulting in a faster website, more accessible, and easier to navigate.


### **Collaboration & Building relationships**
In my previous roles, I have adopted a networked approach, collaborating with other teams to achieve joint goals (e.g. with Procurement to negotiate better prices) and maintaining strong relationships with key stakeholders (e.g. office suppliers and benefit providers). During my Software Engineering training, I have adapted to different team dynamics, supported those who were struggling so they would not fall behind (e.g.project setup), and learned CSS on the go to help the team complete the project successfully when we found ourselves in a group without previous experience in this language. After the end of the course, my peer group and I decided to continue meeting and working together on projects, so we developed [Pensano Devs](https://pensano.dev/).
